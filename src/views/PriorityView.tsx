                  ...
                  <tr key={project.id} onClick={() => onProjectClick(project.id)} className="hover:bg-surface-container-low transition-colors group cursor-pointer">
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        <span className="font-headline font-bold text-on-surface">{project.title}</span>
                        <span className="text-xs text-on-surface-variant line-clamp-1">{project.description}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        <div className="w-6 h-6 rounded-full bg-primary-container flex items-center justify-center text-[10px] font-bold text-primary">{project.owner.name.charAt(0)}</div>
                        <span className="text-sm font-medium text-on-surface">{project.owner.name}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="w-24 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                        <div className="h-full bg-tertiary-fixed-dim" style={{ width: `${project.progress}%` }}></div>
                      </div>
                    </td>
                ...
                {index % 3 === 2 ? (
                  <>
                    <div className="relative z-10">
                      <h4 className="font-headline font-bold text-lg mb-1 leading-tight">{project.title}</h4>
                      <p className="text-xs text-blue-100 max-w-[200px] line-clamp-2">{project.description}</p>
                    </div>
